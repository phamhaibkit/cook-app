...
class PageHome extends Component {
  ...
  render() {
    ...
    return (
      <ContainerScroll enableScroll={!trendings.loading && !collections.loading && !ads.loading && !combos.loading && !products.loading && !followers.loading && !likeRecipes.loading && !newsEvents.loading}>
        <View style={styles.container}>
          ...
          { ads.loading ? <Spinner /> : <Advertiment paddingHori={CSS.padding15} data={ads} marginTop={30}/>}
