        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          <View style={styles.container}>
            ...
            <Text
              ...
              {LANG.USER_INFOR_PAGE_DES}
            </Text>
            <SigninByFacebook
              titleButton="Sử dụng thông tin Facebook"
              goto={"InforUser"}
              getLoginFaceBookInfor={this.getInforFacebook}
              style={{ marginTop: 20 }}
            />
            <Text
              style={[
                { marginTop: 20, color: "#898989" },
                CSS.fontQuiRegular,
                CSS.fontSize13,
                CSS.textAlignCenter
              ]}>
            ...
            <TextInputRendernder
              onChangeText={(value, err) =>
                this.onChangeText(value, err, "placeLive")
              }
              title="Nơi sinh sống"
            ...
            <TextInputRendernder
              onChangeText={(value, err) =>
                this.onChangeText(value, err, "placeBorn")
              }
              title="Bạn sinh ra ở"
              placeholder="Nhập nơi sinh"
              value={placeBorn} />
            <RadioSelect
              onChangeSelect={value => this.onChangeSelect(value, "", "sex")}
              radioObject={radioObject} />
            <DatePickerCustom
              changeDateSelected={value =>
                this.onChangeSelect(value, "", "dateOfBirth")
              }
              title="Ngày sinh"
            ...
            <TextInputRendernder
              onChangeText={(value, err) =>
                this.onChangeText(value, err, "desctiption")
              }
              title="Mô tả"
            ...
            <LinearGradient
              ...
              style={CSS.linearGradientButton}>
              <TouchableOpacity
                style={[
                  CSS.buttonText,
                  CSS.alignItemsCenter,
